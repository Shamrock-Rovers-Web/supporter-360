#!/bin/bash
# Supporter 360 Database Schema Deployment Script
# Run this from your EC2 bastion host
...
echo "Supporter 360 Database Schema Deployment"
echo "========================================="
echo ""
...
if [ -n "$1" ]; then
    ...
    echo "Enter database password (from Secrets Manager -> Supporter360StackSupporter3-0P3cLJNP4WIM):"
    read -s DB_PASSWORD
    echo ""
fi
